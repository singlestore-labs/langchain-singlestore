...
class ChatSingleStore(BaseChatModel):
    ...
    """SingleStore chat model integration.
    ...
    Key init args — completion params:
        model: str
            Name of SingleStore model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            SingleStore API key. If not passed in will be read from env var SINGLESTORE_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatSingleStore.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatSingleStore.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatSingleStore supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatSingleStore supports async generation. Otherwise delete.
