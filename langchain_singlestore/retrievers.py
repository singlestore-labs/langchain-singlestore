...
class SingleStoreRetriever(BaseRetriever):
    ...
    """SingleStore retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-singlestore`` and set environment variable
        ``SINGLESTORE_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-singlestore import SingleStoreRetriever

            retriever = SingleStoreRetriever(
                # ...
            )
